...
The parties of this Licence Agreement acknowledge that the Services are not a Party to this Licence Agreement and are not bound by any provisions or obligations with regard to the Licensed Application, such as warranty, liability, maintenance and support thereof. JDCODE Inc, not the Services, is solely responsible for the Licensed Application and the content thereof.
This Licence Agreement may not provide for usage rules for the Licensed Application that are in conflict with the latest Apple Media Services Terms and Conditions and Google Play Terms of Service ('Usage Rules'). JDCODE Inc acknowledges that it had the opportunity to review the Usage Rules and this Licence Agreement is not conflicting with them.
Green House when purchased or downloaded through the Services, is licensed to You for use only under the terms of this Licence Agreement. The Licensor reserves all rights not expressly granted to You. GreenHouse is to be used on devices that operate with Apple's operating systems ('iOS' and 'Mac OS') or Google's operating system ('Android').\n
...
1. THE APPLICATION
Green House ('Licensed Application') is a piece of software created to facilitate sale of plants via mobile phone - and customised for iOS and Android mobile devices ('Devices'). It is used to sale of plants.
...
2.3 You may not share or make the Licensed Application available to third parties (unless to the degree allowed by the Usage Rules, and with JDCODE Inc's prior written consent), sell, rent, lend, lease or otherwise redistribute the Licensed Application
2.4 You may not reverse engineer, translate, disassemble, integrate, decompile, remove, modify, combine, create derivative works or updates of, adapt, or attempt to derive the source code of the Licensed Application, or any part thereof (except with JDCODE Inc's prior written consent).
...
2.8 Nothing in this licence should be interpreted to restrict third-party terms. When using the Licensed Application. You must ensure that you comply with applicable thirdparty terms and conditions.\n


3. TECHNICAL REQUIREMENTS
3.1 The Licensed Application requires a firmware version Android 10 or ios 13 or higher. Licensor recommends using the latest version of the firmware
...
4.2 JDCODE Inc and the End-User acknowledge that the Services have no obligation whatsoever to furnish any maintenance and support services with respect to the Licensed Application.\n

5. USE OF DATA
You acknowledge that Licensor will be able to access and adjust your downloaded Licensed Application content and your personal information, and that Licensor's use of such material and information is subject to your legal agreements with Licensor and Licensor's privacy policy: https://app.termly.io/dashboard/website/38a43de6-Oca647d2-a7c3-00892becc253/privacy-policy
...
9.2 No warranty is provided for the Licensed Application that is not executable on the device, that has been unauthorisedly modified, handled inappropriately or culpably, combined or installed with inappropriate hardware or software, used with inappropriate accessories, regardless if by Yourself or by third parties, or if there are any other reasons outside of JDCODE Inc's sphere of influence that affect the executability of the Licensed Application.
9.3 You are required to inspect the Licensed Application immediately after installing it and notify JDCODE Inc about issues discovered without delay by email provided in Product Claims. The defect report will be taken into consideration and further investigated if it has been emailed within a period of thirty (30) days after discovery.
9.4 If we confirm that the Licensed Application is defective, JDCODE Inc reserves a choice to remedy the situation either by means of solving the defect or substitute delivery
...
10. PRODUCT CLAIMS
JDCODE Inc and the End-User acknowledge that JDCODE Inc, and not the Services, is responsible for addressing any claims of the End-User or any third party relating to the Licensed Application or the End-User's possession and/or use of that Licensed Application, including, but not limited to:
(1) product liability claims;
(ii) any claim that the Licensed Application fails to conform to any applicable legal or regulatory requirement, and
(iii) claims arising under consumer protection, privacy, or similar legislation, including in connection with Your Licensed Application's use of the Health it and HomeKit.\n
...
Joshua Devine 2 George Street Sydney, New South Wales 2000 Australia joshua devine24@hotmail.com\n

13. TERMINATION
The licence is valid until terminated by JDCODE Inc or by You. Your rights under this licence will terminate automatically and without notice from JDCODE Inc if You fail to adhere to any term(s) of this licence. Upon Licence termination, You shall stop all use of the Licensed Application, and destroy all copies, full or partial, of the Licensed Application.\n

14. THIRD-PARTY TERMS OF AGREEMENTS AND BENEFICIARY
JDCODE Inc represents and warrants that JDCODE Inc will comply with applicable third-party terms of agreement when using Licensed Application.
...
15. INTELLECTUAL PROPERTY RIGHTS
JDCODE Inc and the End-User acknowledge that, in the event of any third-party claim that the Licensed Application or the End-User's possession and use of that Licensed Application infringes on the third party's intellectual property rights, JDCODE Inc, and not the Services, will be solely responsible for the investigation, defence, settlement, and discharge or any such intellectual property infringement claims.\n
